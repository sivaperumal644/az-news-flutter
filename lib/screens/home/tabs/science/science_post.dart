...
Future<Post> fetchPostScience() async {
  final response = await http.get('https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=47ada2986be0434699996aaf4902169b');
...
class Science extends StatelessWidget{
  ...
  Science({Key key, this.post}) : super (key : key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: fetchPostScience,
        child: Center(
