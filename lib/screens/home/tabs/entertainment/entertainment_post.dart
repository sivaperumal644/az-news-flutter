...
Future<Post> fetchPostEntertainment() async {
  final response = await http.get('https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=47ada2986be0434699996aaf4902169b');
...
class Entertainment extends StatelessWidget{
  ...
  Entertainment({Key key, this.post}) : super (key : key);
