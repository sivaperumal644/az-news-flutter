...
Future<Post> fetchPostBusiness() async {
  final response = await http.get('https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=47ada2986be0434699996aaf4902169b');
...
class Business extends StatelessWidget{
  ...
  Business({Key key, this.post}) : super (key : key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: fetchPostBusiness,
        child: Center(
