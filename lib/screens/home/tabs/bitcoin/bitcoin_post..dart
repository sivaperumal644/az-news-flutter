...
Future<Post> fetchPostBitcoin() async {
  final response = await http.get('https://newsapi.org/v2/everything?q=bitcoin&sortBy=publishedAt&apiKey=47ada2986be0434699996aaf4902169b');
...
class Bitcoin extends StatelessWidget{
  ...
  Bitcoin({Key key, this.post}) : super (key : key);
